...
include('conexao.php');
$id_edita = $_POST['editar'];
//$sql = "SELECT FROM `tbl_tarefas` WHERE id = '{$id}'";
$sql = "SELECT * FROM `tbl_tarefas` WHERE id = '{$id_edita}'";
					...
					<div class="col-md-12">
						<div class="widget">
							<header class="widget-header">
								<h4 class="widget-title">Editar tarefa</h4>
							...
							<div id="alerta" class="alert alert-success alert-dismissible" role="alert">
								...
								<span>Sua tarefa foi Editada <a href="./../../default/panels.php">Ver tarefas</a></span>
							</div>
							<!--
								<script>								
										setTimeout(function(){
...
-->
							...
							<div class="widget-body">
								<form action="./classes/TarefasCrud.php?editar" method="post" class="form-horizontal">
									<input type="hidden" name="id" value="<?php echo $row['id'];?>"/>
									<div class="form-group">
										<label for="#" class="col-sm-2 col-sm-offset-2 control-label">Nome da Tarefa</label>
										<div class="col-sm-5">
											<input class="form-control input-lg" type="text" name="nome" placeholder="Nome" value="<?php echo $row['nome'];?>">
										</div>
									</div><!-- .form-group -->
									<div class="form-group">
										<label for="textarea1" class="col-sm-2 col-sm-offset-2 control-label">Descricao:</label>
										<div class="col-sm-5">
											<textarea class="form-control" id="textarea1" name="descricao" placeholder="Sua Descrição"><?php echo $row['descricao'];?>
											</textarea>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="date" id="datetimepicker5" name="data_final" class="form-control" value="<?php echo $row['data_final'];?>">
										</div><!-- .form-group -->
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<select class="form-control input-lg" name="status" value="<?php  echo $row['status'];?>" selected="selected">
									...
									<!-- .form-group -->
									<button type="submit" class="btn btn-primary col-sm-offset-8">Salvar</button>
								</form>
							</div><!-- .widget-body -->
						</div><!-- .widget -->
					</div><!-- END column -->
